...
exports.FffmpegExec = void 0;
const child_process_1 = require("child_process");
const command_executer_1 = require("../core/executer/command.executer");
...
class FffmpegExec extends command_executer_1.CommandExecuter {
    constructor(logger) {
        super(logger);
...
exports.FffmpegExec = FffmpegExec;
